...
do
  ...
  then
    jsonvalue="$(echo "{\"Name\":\"${service_to_register}\", \"Address\":\"${host_ip}\", \"Tags\": [\"kong\"], \"Port\":$nginx_port, \"Check\": "{\"Name\": \"Check Script\", \"Script\": \"ping -c1 google.com\", \"Interval\": \"10s\", \"Timeout\": \"30s\"}"}")"
